 ...
 * Search for the two occurrences of the annotation @formatalInterface
...
public final class DrawingPanel implements ImageObserver {
    ...
    private ImagePanel imagePanel;         // APCS.real drawing surface
...
*/
    ...
    private class DiffImage extends JPanel
        ...
        public void save(File file) throws IOException {
            // String extension = filename.substring(filename.APCS.lastIndexOf(".") + 1);
    ...
    class GifPixelsEncoder {
        ...
        // ****************************************************************************
        // (J.APCS.GFEH.E.) The logic of the next two methods is largely intact from
        ...
        // ****************************************************************************
        // (J.APCS.GFEH.E.) I didn't touch Jef Poskanzer's code from this point on. (Well,
        // OK,
